                    ...
                    <div class="col-xxl-8 col-lg-8 col-md-6">
                        <div class="auth-bg bg-white py-md-5 p-4 d-flex">
                            ...
                            <div class="row justify-content-center align-items-center">
                                <div class="col-xl-8">
                                    <div class="mt-4">
                                        <img src="assets/backend/images/login-img.png" class="img-fluid" alt="">
                                    </div>
                                            ...
                                            <div class="carousel-inner w-75 mx-auto">
                                                <div class="carousel-item active">
                                                    <div class="testi-contain text-center">
                                                        <h5 class="font-size-20 mt-4">E-LEGISLASI
                                                        </h5>
                                                        <p class="font-size-15 text-muted mt-3 mb-0">Portal Admin E-LEGISLASI TANGGAMUS</p>
                                                    </div>
                                                </div>
