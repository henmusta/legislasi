                ...
                <form id="formUpdate" action="{{ route('backend.users.update', Request::segment(3)) }}">
                    ...
                    <div class="card-body">
                      ...
                      <div class="d-flex flex-column">
                        ...
                        <div class="mb-3">
                            <label for="select2Jabatan">Jabatan <span class="text-danger">*</span></label>
                            <select id="select2Jabatan" style="width: 100% !important;" name="jabatan_id">
                              <option value="{{ $data['jabatan']['id'] ?? '' }}">{{ $data['jabatan']['name'] ?? '' }}</option>
                            </select>
                        </div>
...
@section('script')
  <script>
    $(document).ready(function () {
      ...
      let select2Jabatan = $('#select2Jabatan');
      ...
      select2Jabatan.select2({
        dropdownParent: select2Jabatan.parent(),
        searchInputPlaceholder: 'Cari Jabatan',
        allowClear: true,
        width: '100%',
        placeholder: 'select jabatan',
        ajax: {
          url: "{{ route('backend.jabatan.select2') }}",
          dataType: "json",
          cache: true,
          data: function (e) {
            return {
