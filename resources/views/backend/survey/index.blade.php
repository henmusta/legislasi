  ...
  <script>
     ...
     $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: {
          url: "{{ route('backend.survey.index') }}",
          data: function (d) {
        ...
        columns: [
          {data: 'name', name: 'name'},
          {data: 'kategorisurvey.name', name: 'kategorisurvey.name'},
    ...
    modalValidasi.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('#formUpdateValidasi').setAttribute('action', '{{ route("backend.survey.validasi") }}');
      });
      ...
      modalDelete.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.survey.index") }}/' + id);
      });
