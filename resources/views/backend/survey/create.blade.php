    ...
    <div class="container-fluid">
      <div class="card">
        <div class="row row-sm">
            <div class="col-12">
                <form id="formStore" action="{{ route('backend.survey.store') }}">
                    @csrf
                    <div class="card-body">
                      <div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="name" name="name"  class="form-control" placeholder="Masukan Judul"/>
                                  </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="deskripsi" class="my-editor form-control" id="deskripsi" cols="30" rows="10"></textarea>
                                  </div>
                            </div>
                        </div>
                        {{-- <div class="row">
