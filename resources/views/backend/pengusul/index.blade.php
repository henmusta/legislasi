  ...
  <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStore" method="POST" action="{{ route('backend.pengusul.store') }}">
          @csrf
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label>Pengusul<span class="text-danger">*</span></label>
              <input type="text" name="name" class="form-control" placeholder="Masukan Pengusul"/>
            </div>
             <div class="mb-3">
                <label>Deskripsi Pengusul <span class="text-danger">*</span></label>
                <textarea type="text" name="deskripsi" class="form-control" placeholder="Masukan Deskripsi Pengusul"></textarea>
              </div>
          </div>
  ...
  <script>
    $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: "{{ route('backend.pengusul.index') }}",
        columns: [
          {data: 'name', name: 'name'},
      ...
      modalEdit.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('#formUpdate').setAttribute('action', '{{ route("backend.pengusul.index") }}/' + event.relatedTarget.getAttribute('data-bs-id'));
      });
      ...
      modalDelete.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.pengusul.index") }}/' + id);
      });
