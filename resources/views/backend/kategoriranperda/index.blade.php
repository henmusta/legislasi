  ...
  <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStore" method="POST" action="{{ route('backend.kategoriranperda.store') }}">
          @csrf
          <div class="modal-body">
            ...
            <div class="mb-3">
                <label>Kategori Ranperda <span class="text-danger">*</span></label>
                <input type="text" name="name" class="form-control" placeholder="Masukan Kategori Ranperda"/>
            </div>
            <div class="mb-3">
                <label>Deskripsi Jabatan <span class="text-danger">*</span></label>
                <textarea type="text" name="deskripsi" class="form-control" placeholder="Masukan Deskripsi Kategori Ranperda"></textarea>
              </div>
          </div>
      ...
      <div class="modal-content">
        ...
        <form id="formUpdate" action="#">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
                <label>Deskripsi  Kategori Ranperda<span class="text-danger">*</span></label>
                <textarea type="text" name="deskripsi" class="form-control" placeholder="Masukan Deskripsi Kategori Ranperda"></textarea>
              </div>
          </div>
          <div class="modal-footer">
  ...
  <script>
    $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: "{{ route('backend.kategoriranperda.index') }}",
        columns: [
          {data: 'name', name: 'name'},
      ...
      modalEdit.addEventListener('show.bs.modal', function (event) {
        ...
        let deskripsi = event.relatedTarget.getAttribute('data-bs-deskripsi');
        this.querySelector('input[name=name]').value = name;
        this.querySelector('textarea[name=deskripsi]').value = deskripsi;
        this.querySelector('#formUpdate').setAttribute('action', '{{ route("backend.kategoriranperda.index") }}/' + event.relatedTarget.getAttribute('data-bs-id'));
      });
      modalEdit.addEventListener('hidden.bs.modal', function (event) {
        this.querySelector('input[name=name]').value = '';
        this.querySelector('textarea[name=deskripsi]').value = '';
        this.querySelector('#formUpdate').setAttribute('href', '');
      });
      modalDelete.addEventListener('show.bs.modal', function (event) {
        let button = event.relatedTarget;
        let id = button.getAttribute('data-bs-id');
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.kategoriranperda.index") }}/' + id);
      });
