  ...
  <div class="modal fade" id="modalCreate" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form id="formStore" method="POST" action="{{ route('backend.jabatan.store') }}">
          @csrf
      ...
      <div class="modal-content">
        ...
        <form id="formUpdate" action="#">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
                <label>Deskripsi Jabatan <span class="text-danger">*</span></label>
                <textarea type="text" name="deskripsi" class="form-control" placeholder="Masukan Deskripsi Jabatan"></textarea>
              </div>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
  ...
  <script>
    $(document).ready(function () {
      ...
      let dataTable = $('#Datatable').DataTable({
        ...
        pageLength: 10,
        ajax: "{{ route('backend.jabatan.index') }}",
        columns: [
          {data: 'name', name: 'name'},
      ...
      modalEdit.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('#formUpdate').setAttribute('action', '{{ route("backend.jabatan.index") }}/' + event.relatedTarget.getAttribute('data-bs-id'));
      });
      ...
      modalDelete.addEventListener('show.bs.modal', function (event) {
        ...
        this.querySelector('.urlDelete').setAttribute('href', '{{ route("backend.jabatan.index") }}/' + id);
      });
